...
{	
	...
	if(BT_CurBaud != BT_BAUD_Set){
		...
		for(i=0;i<9;i++)
		{
			LedA_on;LedB_on;LedC_on;
			delay_ms(1000);
			LedA_off;LedB_off;LedC_off;
			delay_ms(1000);
